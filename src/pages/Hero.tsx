...
export default function Hero() {
  useEffect(() => {
    gsap.from(".hero-text", { y: 80, opacity: 0, duration: 1.2, stagger: 0.2, ease: "power3.out" });
    gsap.from(".hero-img", { scale: 0.9, opacity: 0, y: 50, duration: 1.4, ease: "power3.out", delay: 0.3 });
  }, []);

  return (
    <section id="hero" className="h-screen flex flex-col justify-center items-center text-center relative bg-gradient-to-b from-[#fffaf4] to-[#f3e3c5] overflow-hidden">
      ...
      <p className="hero-text text-lg md:text-xl font-medium text-[#6b4a43] opacity-80 mb-8 max-w-xl">
        Experience nature’s finest remedies, designed to elevate your health and vitality 🌿
      </p>
      ...
      <div className="relative mt-16">
        <img src={handImage} alt="Hand" className="hero-img absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] z-10" />
        <img src={heroImg} alt="Medicine" className="hero-img relative w-[240px] md:w-[360px] z-20 drop-shadow-2xl" />
      </div>
    </section>
  );
}
